...
//    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public void getInfoFile(@RequestPart MultipartFile file,@RequestPart MultipartFile file2, @RequestParam(name = "soP") String soP,Long id) throws IOException {
        deThiService.Createde(file,file2,soP,id);
    }
}
